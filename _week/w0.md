---
layout: week_layout
title: Pre-course materials (TBD)
week_num: 0
...
- [The Greek Alphabet (English pronunciation for math & science)](#the-greek-alphabet)
- [Common math notations with Python examples](#common-math-notations-with-python-examples)
...
_Adapted from [math-as-code](https://github.com/Jam3/math-as-code)._
