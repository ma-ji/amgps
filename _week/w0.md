...
week_num: 0
session_date: Before week of 2022/08/22
description:
---

Jump to: [The Greek Alphabet (English pronunciation for math & science)](#the-greek-alphabet) / [Common math notations with Python examples](#common-math-notations-with-python-examples)
...
_Adapted from [math-as-code](https://github.com/Jam3/math-as-code). Programming is just for your reference, not a required component._
